...
public class SquareInfo extends javax.swing.JFrame implements Node{
    ...
    public SquareInfo(MyPanel myPanel, JComboBox<String> jComboBox1) {
        initComponents();
    ...
    private void initComponents() {
        ...
        sideLengthTextField.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N

        addButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        addButton.setText("Add Square");
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(yCoordinateTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addComponent(sideLengthTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try
        {
        if(sideLengthTextField.getText().equals("")||xCoordinateTextField.getText().equals("")||yCoordinateTextField.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Some fields are empty");
            sideLengthTextField.setText("");
        ...
        else if(Integer.parseInt(sideLengthTextField.getText())<0){
            JOptionPane.showMessageDialog(null,"Side lengyth must be bigger than 0");
            sideLengthTextField.setText("");
          
        }
        else{
            sideLength = Integer.parseInt(sideLengthTextField.getText());
            ...
            Rectangle square = new Rectangle(sideLength, sideLength, coordinates);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SquareInfo(null, null).setVisible(true);
            }
        });
    }
